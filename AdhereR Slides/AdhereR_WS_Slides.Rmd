...
- *Adherence* = the extent to which a patient's medication availability corresponds to prescribed regimens, expressed as continuous multiple-interval measures of medication availability (CMA)
- *Initiation* = the length of time between the first prescribing event and the first dispensing event
...
presc_events_A09 <- presc_events[grepl("^A09",ATC.CODE),]
disp_events_A09 <- disp_events[grepl("^A09",ATC.CODE),]
```
...
- Requires prescription and dispensing data - `compute.event.durations()` function
...
TEs3<- compute.treatment.episodes(ExamplePats,
                                  ...
                                  date.format = "%m/%d/%Y");
knitr::kable(
  TEs3, table.attr = "style='width:25%;'", 
