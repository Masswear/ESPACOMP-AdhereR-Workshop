...
TEs3<- compute.treatment.episodes(ExamplePats,
                                  ...
                                  date.format = "%m/%d/%Y");
knitr::kable(
  TEs3, table.attr = "style='width:30%;'", 
...
- summarizing multiple medications
    + continuous: compute CMA for all treatments (without carryover for different treatments)
    + continuous: compute the mean for individual CMAs (unweighted)
    + continuous: mean of individual CMAs, weighted by treatment episode (DPPR) 
    + continuous: compute CMA for each treatment separately and consider only periods where all treatments were available 
    + dichotomized: CMA for all treatments larger than cutoff
