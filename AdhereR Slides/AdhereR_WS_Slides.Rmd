...
- Adherence estimations based on *Electronic healthcare data* (EHD) are central to research and clinical practice across clinical conditions
...
- Different adherence estimates from same data
...
- New AdhereR function to:
    1. automatically select the last prescibed dose to calculate supply duration,
...
## Data exploration/Visualization {.build}
...
plot(cma0, # the object to plot
     ...
     col.cats = c("red", "blue")) # make colors a bit nicer
```
...
- No difference between implementation and persistence
- ...
