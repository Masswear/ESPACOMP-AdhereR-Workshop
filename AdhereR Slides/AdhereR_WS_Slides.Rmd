...
<img src="figures/hess_example.JPG" style="width: 100%"/>
...
<figure>
<img src="figures/R_Rcorrect-1.png" style="width: 100%"/>
...
```{r, echo = FALSE}
# example_data <- med.events[med.events$PATIENT_ID == 76, ]
example_data$rownr <- 1:nrow(example_data)
dropdownButton(
  ...
  checkboxInput(inputId = "dose_change1", label = "Consider dosage change", value = TRUE),
  checkboxInput(inputId = "new_episode1", label = "New episode after medication change", value = TRUE),
...
- Requires prescription and dispensing data
...
time_init <- time_to_initiation(presc.data = presc_val,
                                disp.data = disp_val,
                                ID.colname = "ID",
...
```{r, echo = FALSE}
example_data <- example_data[example_data$PATIENT_ID == 37,]
...
dropdownButton(
  ...
  checkboxInput(inputId = "dose_change2", label = "Consider dosage change", value = TRUE),
