...
plot(cma0, col.cats = rainbow, show.legend = FALSE)
for(i in 1:nrow(TEs)){
  class.i = TEs[[i, "class"]]
...
> - `CMA_sliding_window(CMA.to.apply, data, ...)`
...
dropdownButton(
  ...
  checkboxInput(inputId = "carry_within2", label = "Carry-over within OW", value = FALSE),
...
cmaW <- CMA_sliding_window(CMA.to.apply="CMA9", # apply the simple CMA9 to each sliding window
                           ...
                           event.daily.dose.colname="PERDAY",
                           medication.class.colname="CATEGORY",
                           carryover.within.obs.window = input$carry_within2,
