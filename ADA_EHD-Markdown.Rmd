...
The output of the `compute_event_durations` function contains some more columns with important information:
...
- is three switch between different medications of the same class or of different classes, and if so, is this an indicator of a new treatment episode? 
