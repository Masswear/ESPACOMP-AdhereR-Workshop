...
Compute time to initiation with the function `time_do_initiation()` for the two patients in `example_data`. Select only medications with the ATC code *R03AC12* (salmeterol). 
